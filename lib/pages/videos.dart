  ...
  Widget build(BuildContext context) {
    List<ModelYoutube> myAppsLis = [
      ...
      ModelYoutube(
          ...
          title:
              "Communicate between Fragments using ViewModel / Kotlin , Ui example",
      ...
      ModelYoutube(
          ...
          title:
              "Android Studio Gallery ViewModel ,Data Binding ,Rest Api , Retrofit2 example in Kotlin",
      ...
      ModelYoutube(
          ...
          title:
              "Android Studio Grid Gallery  ViewModel ,Data Binding ,Rest Api , Retrofit2 example",
          href: "https://www.youtube.com/watch?v=cACHcjwv7Mk"),
      ModelYoutube(
          image: "https://i.ytimg.com/vi/JOUGOIySLGk/maxresdefault.jpg",
          title:
              "Android Studio  Footbal News ViewModel ,Live Data ,Rest Api , Okhttp example",
          href: "https://www.youtube.com/watch?v=JOUGOIySLGk"),
      ModelYoutube(
          image: "https://i.ytimg.com/vi/X9slxOEGilM/maxresdefault.jpg",
          title:
              "Android Studio-#Tip8 CSV Google spreadsheet /Example Source Code",
          href: "https://www.youtube.com/watch?v=X9slxOEGilM"),
      ModelYoutube(
          image: "https://i.ytimg.com/vi/RO20k85h7f0/maxresdefault.jpg",
          title:
              "Aplikacja pogodowa w Android Studio Część 2 - Rest Api OkHttp",
          href: "https://www.youtube.com/watch?v=RO20k85h7f0"),
      ModelYoutube(
          image:
              "https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/YouTube_social_white_squircle_%282017%29.svg/1200px-YouTube_social_white_squircle_%282017%29.svg.png",
              ...
              child: SingleChildScrollView(
                ...
                children: [
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(0).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(1).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(2).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(3).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(4).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(5).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(6).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(7).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(8).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(9).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(10).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(11).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(12).href]);
                    },
                    child: MenuCard(
                  ...
                  InkWell(
                    onTap: () {
                      js.context
                          .callMethod("open", [myAppsLis.elementAt(13).href]);
                    },
                    child: MenuCard(
